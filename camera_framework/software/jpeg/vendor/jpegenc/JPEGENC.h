...
#ifndef __JPEGENC__
#define __JPEGENC__
/* Modified for SiFli: allow freestanding portable builds without Arduino. */
#if defined( JPEGENC_PORTABLE ) || defined( MICROPY_PY_SENSOR ) || defined( __MACH__ ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined( ESP_PLATFORM )
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
